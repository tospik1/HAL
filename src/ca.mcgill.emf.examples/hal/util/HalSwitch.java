...
public class HalSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HalPackage.RELATIONAL_TERMS: {
				RelationalTerms relationalTerms = (RelationalTerms)theEObject;
				T result = caseRelationalTerms(relationalTerms);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HalPackage.BOOLEAN_OPERATORS: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Relational Terms</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Relational Terms</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRelationalTerms(RelationalTerms object) {
		return null;
	}
